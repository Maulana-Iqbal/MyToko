...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Tagihan Pembayaran</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-12">
        <div class="card">
            ...
            @if(session('alert')=='error')
                ...
                <!-- <form action="/print-laporan-invoice" target="_blank" method="post">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col align-selft-start input-daterange">
                            ...
                            <div class="col-4">
                                <label for="status_inv">Status</label>
                                <select name="status_inv" id="status_inv" class="form-control">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-info">
                <h4 class="modal-title" id="success-header-modalLabel">Tagihan Pembayaran</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <form id="invoiceForm" name="invoiceForm" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <label for="nomor" class="form-label">No. Nota <small>(hanya Penjualan dengan status PROSES ditampilkan)</small></label>
                            ...
                            <div class="mb-2">
                                <label for="status_invoice" class="form-label">Status</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '', status_inv = '') {
        ...
        $('#filter').click(function() {
            ...
            load_data(from_date, to_date, status_inv);
            $("#print").val('Print');
            $("#export").val('Export');
        ...
        $('.aksiBtn').click(function(e) {
            ...
            aksi = $(this).data('id');
            if (aksi == 1) {
                url = "{{ url('/verifikasi-invoice') }}" + '/' + aksi
            } else
            if (aksi == 2) {
                url = "{{ url('/verifikasi-invoice') }}" + '/' + aksi
            }
        ...
        $('#createNewQuotation').click(function() {
            ...
            $('#modelHeading').html("Tambah Tagihan");
        ...
        $('body').on('click', '.editQuotation', function() {
            ...
            $.get("{{ url('/invoice') }}" + '/' + id_invoice + '/edit', function(data) {
                $('#modelHeading').html("Ubah Tagihan");
                ...
                $('#di').val(data.di);
                $('#status_invoice').val(data.status);
        ...
        $('body').on('click', '.ajukanQuotation', function() {
            ...
            swal({
                    ...
                    text: "Mengirim Tagihan Pembayaran Kepada Customer!",
                    type: "warning",
                ...
                function(isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "post",
                            url: "{{ url('/invoice/kirim') }}" + '/' + id_invoice,
                            success: function(data) {
                                $('#datatable').DataTable().destroy();
                                load_data();
                                $("#canvasloading").hide();
