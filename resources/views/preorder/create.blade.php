                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="mb-2">
                                ...
                                <label for="gudang" class="control-label">Untuk Gudang</label>
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="cart-table" class="table table-bordered table-centered" style="min-width: 900px;">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control nilai" type="text" name="input-ppn" maxlength="2" id="input-ppn" value="0" placeholder="%" data-bs-original-title="" title="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12">
                            ...
                            <small>Jika Status (Kirim) maka PO otomatis di Kirim ke Email Supplier</small>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-12">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 d-none">
                            ...
                            <input type="text" class="form-control rupiah" id="bayar" autocomplete="off" name="bayar">
...
<script>
    $(document).ready(function() {
        ...
        function getCartTable() {
            $(".tbody").load("{{url('preorder/cart-table')}}", function() {
                hitung();
            });
        }
        ...
        $("body").on("change", "#cartJumlah", function() {
            ...
            $.ajax({
                type: "post",
                url: "{{ url('/preorder/cart-update-jumlah') }}",
                data: {
                    id: id,
                    produkId: produkId,
                    gudangId: gudangId,
        ...
        $("body").on("click", "#cartRemove", function() {
            ...
            $.ajax({
                type: "post",
                url: "{{ url('/preorder/cart-remove') }}" + '/' + id_produk,
                success: function(data) {
                    getCartTable()
                    $("#canvasloading").hide();
                    $("#loading").hide();
        ...
        function kode_preorder() {
            $.ajax({
                url: "{{ url('/preorder/kode') }}",
                type: "get",
                dataType: 'json',
                success: function(data) {
                    $("#nota").val(data.data);
