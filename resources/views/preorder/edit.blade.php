...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Ubah Pesanan Pembelian</h4>
        </div>
        <form action="{{url('preorder/update')}}" method="post">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 d-none">
                            ...
                            <input type="text" class="form-control rupiah" name="bayar" autocomplete="off" id="bayar" value="{{$data->bayar}}">
