...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Kas & Bank</h4>
            </div>
        </div>
    </div>
    <ul class="nav nav-tabs nav-bordered mb-3">
        <li class="nav-item">
            <a href="#dataKasBank" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                {{-- <i class="mdi mdi-home-variant d-md-none d-block"></i> --}}
                <span class="d-none d-md-block">Kas & Bank</span>
            </a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content">
        <div class="tab-pane show active" id="dataKasBank">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (auth()->user()->level == 'SUPERADMIN' or auth()->user()->level == 'STAFF' or auth()->user()->level == 'ADMIN')
                                <div class="mb-2">
                                    <button type="button" id="createNewKasBank" class="btn btn-primary"
...
@include('kasBank.modal.modalKasBank')

@include('kasBank.jsKasBank')
@endsection
