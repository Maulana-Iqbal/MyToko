            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        ...
                        <button type="button" id="createNewJurnal" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#success-header-modal"><i class="mdi mdi-plus-circle"></i>
                            Tambah</button>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-2">
                                <label for="nomor" class="form-label">No. Referensi</label>
                                ...
                                <div id="inputFormRow">
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="text" name="akun[]" class="form-control akun" readonly placeholder="Pilih Akun">
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            <label for="">Debit</label>
                                            <input type="text" class="form-control debit rupiah" id="debit" name="debit[]" placeholder="0" required="">
                                        </div>

                                        <div class="col-md-3 mb-2">
                                            <label for="">Kredit</label>
                                            <input type="text" class="form-control kredit rupiah" id="kredit" name="kredit[]" placeholder="0" required="">
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" id="total-kredit">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="ajaxModelAkun" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-info">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("focusout", ".debit", function() {
            var sum = 0;
            $(".debit").each(function() {
        ...
        $(document).on("focusout", ".kredit", function() {
            var sum = 0;
        ...
        $("#addRow").click(function() {
            ...
            html += '<div class="row">';
            html +=
                '<div class="col-md-4 mb-2"><label for="">Akun</label><input type="hidden" name="idAkun[]" id="idAkun"><input type="text" name="akun[]" class="form-control akun" readonly placeholder="Pilih Akun"></div>';
            html +=
                '<div class="col-md-3 mb-2"><label for="">Debit</label><input type="text" class="form-control debit rupiah" id="debit" name="debit[]" placeholder="0" required=""></div>';
            html +=
                '<div class="col-md-3 mb-2"><label for="">Kredit</label><input type="text" class="form-control kredit rupiah" id="kredit" name="kredit[]" placeholder="0" required=""></div>';
            html += '<div class="col-md-2 mb-2"><div class="input-group-append">';
            html += '<label for="">Aksi</label><br><button id="removeRow" type="button" class="btn btn-danger">X</button>';
            html += '</div>';
            html += '</div>';
            html += '</div>';
