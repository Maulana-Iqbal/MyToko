            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        ...
                        <button type="button" id="createNewPengeluaran" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#success-header-modal"><i class="mdi mdi-plus-circle"></i>
                            Tambah</button>
                            ...
                            <div id="inputFormRow">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-2">
                                        ...
                                        <input type="text" class="form-control rupiah" id="biaya" name="biaya[]" placeholder="0" required="">
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#addRow").click(function() {
            ...
            html +=
                '<div class="col-md-5 mb-2"><label for="">Jumlah</label><input type="text" class="form-control rupiah" id="biaya" name="biaya[]" placeholder="0" required=""></div>';
