            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        ...
                        <button type="button" id="createNewPenerimaan" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#success-header-modal"><i class="mdi mdi-plus-circle"></i>
                            Tambah</button>
                        @endif
                    </div>
                    <!-- <div class="col-sm-8">
                            ...
                            <div id="inputFormRow">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-2">
                                        ...
                                        <input type="text" class="form-control rupiah" id="jumlah" name="jumlah[]" placeholder="0" required="">
                                    </div>
...
<!-- Modal -->
<div class="modal fade" id="bulkVerifikasi" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-info">
                <h5 class="modal-title" id="staticBackdropLabel">Verifikasi Penerimaan</h5>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#addRow").click(function() {
            ...
            html += '<div class="row">';
            html +=
                '<div class="col-md-5 mb-2"><label for="">Akun</label><input type="hidden" name="idAkun[]" id="idAkun"><input type="text" name="akun[]" class="form-control akun" readonly placeholder="Pilih Akun"></div>';
            html +=
                '<div class="col-md-5 mb-2"><label for="">Jumlah</label><input type="text" class="form-control rupiah" id="jumlah" name="jumlah[]" placeholder="0" required=""></div>';
