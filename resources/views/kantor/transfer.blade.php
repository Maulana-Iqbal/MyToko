            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        ...
                        <button type="button" id="createNewTransfer" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#success-header-modal"><i class="mdi mdi-plus-circle"></i>
                            Tambah</button>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-2">
                            ...
                            <input type="text" class="form-control rupiah" id="jumlah" name="jumlah" placeholder="Rp. xxxxxxx" required="">
