...
<head>
    ...
    <title>{{ website()->nama_website }} - INVOICE {{ $transaksi->kode_trans }}</title>
...
<body>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <table align="right" style="margin-bottom: 20px; width: 500px; margin-right:30px;">
                        <tr>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <table width="50%" cellpadding="4" align="right" cellspacing="0" border="1px" style="margin-top: 20px; margin-right:30px;">
                ...
                <div class="col-md-12">
                    ...
                    <table width="50%" cellpadding="4" cellspacing="0" align="right" border="1px" style="margin-top: 20px; margin-right:30px;">
                        <tr>
