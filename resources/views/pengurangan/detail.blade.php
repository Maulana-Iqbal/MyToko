        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">Pengurangan Stock</li>
                </ol>
            </div>
            <h4 class="page-title">Detail Pengurangan Stock</h4>
        </div>
    </div>
</div>
<!-- end page title -->
        ...
        <div class="card p-2 m-2">
            <div class="card-body">
                ...
                <div class="clearfix">
                    ...
                    <div class="float-start">
                        <h4 class="m-0 d-print-none">Detail Pengurangan Stock</h4>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-4 offset-sm-2">
                        <div class="float-sm-end">
                            ...
                            <p class="font-13"><strong>Nomor: </strong> <span class="float-end">{{$data->nomor}}</span></p>
                        </div>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
