    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            @if(session('alert')=='error')
                ...
                @endif
                <div class="col-lg-12">
                            @if(auth()->user()->can('pengurangan') or auth()->user()->can('pengurangan-create'))
                    <a href="{{url('pengurangan/create')}}" class="btn btn-primary mb-2"><i class="mdi mdi-plus-circle me-2"></i>
                        Tambah Pengurangan</a>
                    @endif
                </div>

                <div class="row">
                    <div class="col-md-12">
                        <form action="{{url('pengurangan/laporan')}}" target="_blank" id="form-filter" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label for="status-order">Status Pengurangan</label>
                            ...
                            @if(auth()->user()->can('pengurangan') or auth()->user()->can('pengurangan-laporan'))
