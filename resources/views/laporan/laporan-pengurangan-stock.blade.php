...
<head>
    ...
    <title>{{ website()->nama_website }} - Laporan Pengurangan Stock</title>
...
<body>
    <div style="width: 98%; margin:auto;">
        ...
        <h3 class="text-center"><u>Laporan Pengurangan Stock</u></h3>
        ...
        <table width="100%" class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{strtoupper($p->kondisi)}}</td>
                </tr>
                <?php
                $t_harga_jual += $p->harga_jual*$p->jumlah;
                $t_harga_final += $p->harga_final*$p->jumlah;
                ...
                <tr class="bold">
                    ...
                    <td align="right">{{uang($t_harga_final)}}</td>
       ...
       $t_harga_modal=$t_harga_final;
        ...
        <table border="1px" width="300px" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                <td><b>Kerugian Kotor</b></td>
                <td align="right">{{uang($t_harga_jual)}}</td>
            </tr>
            <tr>
                <td><b>Kerugian Bersih</b></td>
                <td align="right">{{uang($t_harga_final)}}</td>
            </tr>
        </table>
    </div>
