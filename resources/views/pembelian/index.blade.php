    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            @if(session('alert')=='error')
                ...
                @endif
                <div class="col-lg-12">
                    @if(auth()->user()->can('pembelian') or auth()->user()->can('pembelian-create'))
                    <a href="{{url('pembelian/create')}}" class="btn btn-primary mb-2"><i class="mdi mdi-plus-circle me-2"></i>
                        Tambah Pembelian</a>
                    @endif
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{url('pembelian/laporan')}}" target="_blank" id="form-filter" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-12 col-sm-12 col-lg-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <label for="status-order">Status Pembelian</label>
                                ...
                                <div class="col-12 col-sm-12 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(auth()->user()->can('pembelian') or auth()->user()->can('pembelian-laporan'))
