...
<div class="row">
    <div class="col-12">
        ...
        <form action="{{url('penjualan/update')}}" method="post">
            @csrf
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="mb-2">
                                <label for="sales" class="control-label">Sales <span style="color: red;">*</span></label>

                                <a target="_blank" href="/sales"><small class="text-primary float-end">Buat Sales Baru</small></a>
                                <select id="sales" name="sales" required class="form-control select2">
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                            <label for="">Metode Bayar <span style="color: red;">*</span></label>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                            ...
                            <input type="text" class="form-control rupiah" name="bayar" id="bayar" value="{{$data->bayar}}">
...
<script>
    $(document).ready(function() {
        ...
        function getCartTable() {
            $(".tbody").load("{{url('penjualan/cart-table')}}", function() {
               hitung();
            });
        ...
        $('body').on('change', '#produk', function() {
            ...
            var url = "{{ url('/penjualan/cart-add') }}";
        ...
        $("body").on("change", "#cartJumlah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: "{{ url('/penjualan/cart-update-jumlah') }}",
                data: {
                    id: id,
                    produkId: produkId,
                    gudangId: gudangId,
        ...
        $("body").on("click", "#cartRemove", function() {
            ...
            $.ajax({
                type: "post",
                url: "{{ url('/penjualan/cart-remove') }}" + '/' + id_produk,
                success: function(data) {
                    getCartTable()
                    $("#canvasloading").hide();
                    $("#loading").hide();
        ...
        $("#sales").select2("trigger", "select", {
            data: {
                id: '{{$data->sales_id}}',
                text: '{{$data->sales->nama}}'
            }
        });
        $("#customer").select2("trigger", "select", {
            data: {
                id: '{{$data->customer_id}}',
                text: '{{$data->pelanggan->nama_depan}} {{$data->pelanggan->nama_belakang}}'
            }
        });
